/**
 * Routing Configuration - Configurations UPDATE Handler
 * 
...
export const route = {
  method: "PUT",
  // path: "/example/configurations/update"
};
 ...
 * the AOT will automatically link: ./src/bo/example/configurations.js::update
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/configurations.js::update"]
// };
