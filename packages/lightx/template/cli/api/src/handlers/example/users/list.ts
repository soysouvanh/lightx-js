/**
 * Routing Configuration - Users LIST Handler
 * 
 ...
 * the AOT will automatically link: ./src/bo/example/users.js::list
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/users.js::list"]
// };
