/**
 * Routing Configuration - User_roles REMOVE Handler
 * 
...
export const route = {
  method: "DELETE",
  // path: "/example/user_roles/remove"
};
 ...
 * the AOT will automatically link: ./src/bo/example/user_roles.js::remove
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/user_roles.js::remove"]
// };
