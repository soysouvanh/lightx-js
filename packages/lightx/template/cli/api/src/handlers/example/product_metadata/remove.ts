/**
 * Routing Configuration - Product_metadata REMOVE Handler
 * 
...
export const route = {
  method: "DELETE",
  // path: "/example/product_metadata/remove"
};
 ...
 * the AOT will automatically link: ./src/bo/example/product_metadata.js::remove
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/product_metadata.js::remove"]
// };
