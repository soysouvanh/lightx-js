/**
 * Routing Configuration - Active_users LIST Handler
 * 
...
export const route = {
  method: "GET",
  // path: "/example/active_users/list"
};
 ...
 * the AOT will automatically link: ./src/bo/example/active_users.js::list
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/active_users.js::list"]
// };
