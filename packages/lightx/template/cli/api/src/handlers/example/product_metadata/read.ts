/**
 * Routing Configuration - Product_metadata READ Handler
 * 
...
export const route = {
  method: "GET",
  // path: "/example/product_metadata/read"
};
 ...
 * the AOT will automatically link: ./src/bo/example/product_metadata.js::read
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/product_metadata.js::read"]
// };
