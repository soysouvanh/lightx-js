/**
 * Routing Configuration - Configurations LIST Handler
 * 
...
export const route = {
  method: "GET",
  // path: "/example/configurations/list"
};
 ...
 * the AOT will automatically link: ./src/bo/example/configurations.js::list
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/configurations.js::list"]
// };
