/**
 * Routing Configuration - Order_items UPDATE Handler
 * 
...
export const route = {
  method: "PUT",
  // path: "/example/order_items/update"
};
 ...
 * the AOT will automatically link: ./src/bo/example/order_items.js::update
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/order_items.js::update"]
// };
