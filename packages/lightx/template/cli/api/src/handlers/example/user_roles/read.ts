/**
 * Routing Configuration - User_roles READ Handler
 * 
 ...
 * the AOT will automatically link: ./src/bo/example/user_roles.js::read
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/user_roles.js::read"]
// };
