/**
 * Routing Configuration - Order_items READ Handler
 * 
 ...
 * the AOT will automatically link: ./src/bo/example/order_items.js::read
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/order_items.js::read"]
// };
