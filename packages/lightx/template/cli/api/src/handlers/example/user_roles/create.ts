/**
 * Routing Configuration - User_roles CREATE Handler
 * 
...
export const route = {
  method: "POST",
  // path: "/example/user_roles/create"
};
 ...
 * the AOT will automatically link: ./src/bo/example/user_roles.js::create
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/user_roles.js::create"]
// };
