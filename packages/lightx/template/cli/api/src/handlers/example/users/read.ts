/**
 * Routing Configuration - Users READ Handler
 * 
 ...
 * the AOT will automatically link: ./src/bo/example/users.js::read
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/users.js::read"]
// };
