/**
 * Routing Configuration - Currencies UPDATE Handler
 * 
...
export const route = {
  method: "PUT",
  // path: "/example/currencies/update"
};
 ...
 * the AOT will automatically link: ./src/bo/example/currencies.js::update
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/currencies.js::update"]
// };
