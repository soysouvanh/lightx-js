/**
 * Routing Configuration - Product_metadata UPDATE Handler
 * 
...
export const route = {
  method: "PUT",
  // path: "/example/product_metadata/update"
};
 ...
 * the AOT will automatically link: ./src/bo/example/product_metadata.js::update
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/product_metadata.js::update"]
// };
