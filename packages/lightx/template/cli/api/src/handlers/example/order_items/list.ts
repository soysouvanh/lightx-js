/**
 * Routing Configuration - Order_items LIST Handler
 * 
 ...
 * the AOT will automatically link: ./src/bo/example/order_items.js::list
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/order_items.js::list"]
// };
