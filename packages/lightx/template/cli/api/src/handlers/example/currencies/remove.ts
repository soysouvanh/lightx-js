/**
 * Routing Configuration - Currencies REMOVE Handler
 * 
...
export const route = {
  method: "DELETE",
  // path: "/example/currencies/remove"
};
 ...
 * the AOT will automatically link: ./src/bo/example/currencies.js::remove
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/currencies.js::remove"]
// };
