/**
 * Routing Configuration - Currencies LIST Handler
 * 
 ...
 * the AOT will automatically link: ./src/bo/example/currencies.js::list
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/currencies.js::list"]
// };
