/**
 * Routing Configuration - Product_metadata CREATE Handler
 * 
...
export const route = {
  method: "POST",
  // path: "/example/product_metadata/create"
};
 ...
 * the AOT will automatically link: ./src/bo/example/product_metadata.js::create
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/product_metadata.js::create"]
// };
