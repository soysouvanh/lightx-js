/**
 * Routing Configuration - Users CREATE Handler
 * 
 ...
 * the AOT will automatically link: ./src/bo/example/users.js::create
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/users.js::create"]
// };
