/**
 * Routing Configuration - User_roles LIST Handler
 * 
 ...
 * the AOT will automatically link: ./src/bo/example/user_roles.js::list
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/user_roles.js::list"]
// };
