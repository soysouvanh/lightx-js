/**
 * Routing Configuration - Currencies CREATE Handler
 * 
...
export const route = {
  method: "POST",
  // path: "/example/currencies/create"
};
 ...
 * the AOT will automatically link: ./src/bo/example/currencies.js::create
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/currencies.js::create"]
// };
