/**
 * Routing Configuration - Order_items CREATE Handler
 * 
...
export const route = {
  method: "POST",
  // path: "/example/order_items/create"
};
 ...
 * the AOT will automatically link: ./src/bo/example/order_items.js::create
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/order_items.js::create"]
// };
