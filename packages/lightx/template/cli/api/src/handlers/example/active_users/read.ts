/**
 * Routing Configuration - Active_users READ Handler
 * 
...
export const route = {
  method: "GET",
  // path: "/example/active_users/read"
};
 ...
 * the AOT will automatically link: ./src/bo/example/active_users.js::read
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/active_users.js::read"]
// };
