/**
 * Routing Configuration - Configurations REMOVE Handler
 * 
...
export const route = {
  method: "DELETE",
  // path: "/example/configurations/remove"
};
 ...
 * the AOT will automatically link: ./src/bo/example/configurations.js::remove
 */
// export const pipeline = {
//   business_objects: ["./src/bo/example/configurations.js::remove"]
// };
